...
int main()
{
  ...
  double z_check_val = sqrt(4*A*-B+B);
  double y_check_val = 2*A;

  ////// Curve 1 Check ///////
  CubitVector expected_startpoint(0.0,y_check_val,-z_check_val);
  ...
  expected_endpoint.set(0.0,-y_check_val,z_check_val);
